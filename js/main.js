...
const students = [
    {
        id:1,
        name: 'Tony Renold M',
        specialization: 'Web Developer - Business Analyst - AI/ML Engineer',
        skills: ['Python/R', 'SQL', 'MongoDB', 'Docker', 'Power BI', 'React','Cybersecurity'],
    ...
    },
    {
        ...
        skills: ['Python', 'Flask','Scikit-learn','JavaScript', 'React/Native', 'SQL', 'SSMS', 'Git/GitHub'],
    ...
    },
    {
        ...
        skills: ['Python', 'Django', 'Pandas', 'Numpy' , 'Scikit-learn', 'SQL','Linux','Github','Colab'],
    ...
    },
    {
        ...
        impact: 'Developed a Soil Fertility Prediction and Visualization using Machine learning.',
        rollNumber: '24pds009',
    ...
    },
    {
        id:35,
        name: 'Nithin K Rajan',
        specialization: 'Graphic & Video Designer - Creative Visual Artist & Designer - Brand identity designer',
        skills: ['Creativity and Innovation', 'Drawing and sketching','Logo Design','Adobe express','Adobe Photoshop'],
